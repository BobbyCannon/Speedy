...
dotnet ef migrations add InitialMigration --framework "net7.0-windows" --configuration "debug" -c "ContosoClientDatabase" -p $projectPath -s $startupPath -o "$projectPath\Migrations"
