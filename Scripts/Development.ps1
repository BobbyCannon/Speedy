...
& "C:\Workspaces\GitHub\Speedy\IncrementVersion.ps1" -Major 12 -Minor 1 -Build 1
...
#
& 'C:\Workspaces\GitHub\Speedy\Build.ps1' -Configuration "Release" -BuildNumber 2 -Verbose
