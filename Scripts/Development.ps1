...
& "C:\Workspaces\GitHub\Speedy\IncrementVersion.ps1" -Major 11 -Minor 0 -Build 5 -Revision 0
...
#
& 'C:\Workspaces\GitHub\Speedy\Build.ps1' -Configuration "Release" -BuildNumber 6
