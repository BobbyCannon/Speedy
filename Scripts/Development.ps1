...
& 'C:\Workspaces\GitHub\Speedy\Build.ps1' -Configuration "Debug" -BuildNumber 0 -VersionSuffix 'RC5'

& 'C:\Workspaces\GitHub\Speedy\Build.ps1' -Configuration "Release" -BuildNumber 0
& 'C:\Workspaces\GitHub\Speedy\Build.ps1' -Configuration "Release" -BuildNumber 0 -VersionSuffix 'RC5'
