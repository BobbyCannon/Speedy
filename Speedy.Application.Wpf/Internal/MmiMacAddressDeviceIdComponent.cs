...
namespace Speedy.Application.Wpf.Internal
{
	...
	/// </summary>
	internal class MmiMacAddressDeviceIdComponent : IDeviceIdComponent
	{
		#region Fields
		...
		public string GetValue()
		{
			...
			try
			{
				return GetValueUsingMicrosoftNetAdapter(_excludeWireless, _excludeNonPhysical);
			}
			catch
			{
			}
		...
		/// <param name="excludeNonPhysical"> A value determining whether non-physical devices should be excluded. </param>
		/// <returns> The component value. </returns>
		private static string GetValueUsingMicrosoftNetAdapter(bool excludeWireless, bool excludeNonPhysical)
		{
