...
namespace Speedy.Samples
{
	public class ContosoMemoryDatabase : Database, IContosoDatabase
	{
			...
			: base(directory, options)
		{
			...
			HasRequired<FoodRelationship, Food, int>(x => x.Child, x => x.ChildId, x => x.ParentRelationships);
			HasRequired<FoodRelationship, Food, int>(x => x.Parent, x => x.ParentId, x => x.ChildRelationships);
