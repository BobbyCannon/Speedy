...
{
	[TestClass]
	public class KeyValueMemoryRepositoryProviderTests
	{
		#region Methods
		...
		public void ArchiveRepositoryInvalidName()
		{
			Cleanup();
			var provider = new KeyValueMemoryRepositoryProvider();
			TestHelper.ExpectedException<SpeedyException>(() => provider.ArchiveRepository("Repository1"), Constants.RepositoryNotFound);
		}
		...
		public void UnarchiveRepositoryInvalidName()
		{
			Cleanup();
			var provider = new KeyValueMemoryRepositoryProvider();
			TestHelper.ExpectedException<SpeedyException>(() => provider.UnarchiveRepository("Repository1"), Constants.RepositoryNotFound);
		}
