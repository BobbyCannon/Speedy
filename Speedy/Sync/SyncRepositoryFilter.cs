	...
	where T : ISyncEntity
{
	...
	/// <inheritdoc />
	public override bool ShouldFilterIncomingEntity(ISyncEntity entity)
	{
		return ShouldFilterIncomingEntity((T) entity);
	}
...
public abstract class SyncRepositoryFilter
{
	...
	/// <param name="entity"> The entity to be tested. </param>
	/// <returns> True if the entity matches the incoming filter or false if otherwise. </returns>
	public abstract bool ShouldFilterIncomingEntity(ISyncEntity entity);
