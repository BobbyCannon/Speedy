...
/// </summary>
public interface IHierarchyListItem : IEventSubscriber, IDisposable
{
	#region Methods
	...
	/// <summary>
	/// Determine if the list item has been disposed of.
	/// </summary>
	/// <returns> True if the list item has been disposed otherwise false. </returns>
	...
	/// </summary>
	/// <returns> True if this items children should be shown. </returns>
